...
class KBTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        for item in data:
            if isinstance(item, Fact) or isinstance(item, Rule):
                # print("asserting---", item, '\n------')
                self.KB.kb_assert(item)
        # print("KBKBKBKBKBKBKBKBKBKBKBKBKBKBKBKBKBKBKBKBKBKBK")
        # print(self.KB)
        # print("KBKBKBKBKBKBKBKBKBKBKBKBKBKBKBKBKBKBKBKBKBKBK")

    # def test1(self):
    #     ask1 = read.parse_input("fact: (motherof ada ?X)")
    #     print("test1 ask -------------", ask1)
    #     if unittest.main.verbosity > 1:
    #         print(' Asking if', ask1)
    #     print(self.KB)
    #     answer = self.KB.kb_ask(ask1)
    #     print("answer1 ans -------------", answer)
    ...
    #     cus_ask = read.parse_input("fact: (doctor C)")
    ...
    #     KB.kb_assert(rule2)
    #     KB.kb_assert(fact3)
    #     print("**********************KB assert finish**********************")
    #     print(KB)
    #     answer1 = KB.kb_ask(ask1)
    #     answer2 = KB.kb_ask(ask2)
    #     print("**********************before kb_retract**********************")
    #     print(KB)
    #     KB.kb_retract(fact1)
    #     print("**********************after kb_retract**********************")
    #     print(KB)
    #     answer3 = ask3 in KB.rules
    #     answer4 = KB.kb_ask(ask1)
    #     answer5 = KB.kb_ask(ask2)

    #     # cus_ans = KB.kb_ask(cus_ask)
    #     # print("***************cus_ans**************\n", cus_ans)
    ...
    def test13(self):
        ...
        # Show the reasoning chain behind the fact below
        fact = read.parse_input("fact: (grandmotherof ada chen)")
        reasoning = self.KB.kb_reasoning_behind_fact(fact)

        print('---------- Reasoning for Test 13 ----------')
        print(reasoning)
        print('-------------------------------------------')
    ...
    #     # Show the reasoning chain behind the fact below
    #     fact = read.parse_input("fact: (auntof eva bing)")
    #     reasoning = self.KB.kb_reasoning_behind_fact(fact)

    #     print('---------- Reasoning for Test 14 ----------')
    #     print(reasoning)
    #     print('-------------------------------------------')
    ...
    #     # Show the reasoning chain behind the fact below
    #     fact = read.parse_input("fact: (doctor A)")
    #     reasoning = self.KB.kb_reasoning_behind_fact(fact)

    #     print('---------- Reasoning for Test 15 ----------')
    #     print(reasoning)
    #     print('-------------------------------------------')
    ...
    #     # Show the reasoning chain behind the fact below
    #     fact = read.parse_input("fact: (reli A F)")
    #     reasoning = self.KB.kb_reasoning_behind_fact(fact)

    #     print('---------- Reasoning for Test 16 ----------')
    #     print(reasoning)
    #     print('-------------------------------------------')
